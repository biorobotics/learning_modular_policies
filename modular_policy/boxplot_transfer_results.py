...
fname1 = 'saved/with_tripod2/zero_shot_data/transfer_results.ptx'
fname2 = 'saved/with_tripod2/zero_shot_data/transfer_results.ptx'
...
ax1.set_title('With gait style objective')
ax1.boxplot([metric_seen1, metric_unseen1],
