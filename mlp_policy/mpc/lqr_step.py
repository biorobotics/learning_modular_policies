...
class LQRStep():
    ...
    def forward(self, x_init, C, c, F, f=None):
        ...
        self.saved_tensors = (x_init, C, c, F, f, new_x, new_u)
        return new_x, new_u
            ...
            if self.u_lower is None:
                if self.n_ctrl == 1 and self.u_zero_I is None:
                    ...
                    if self.u_zero_I is None:
                        ...
                        Qt_uu_[Qt_uu_I.to(torch.bool)] = 0.
                        Qt_uu_[util.bdiag(I).to(torch.bool)] += 1e-8

                        Qt_ux_ = Qt_ux.clone()
                        Qt_ux_[I.unsqueeze(2).repeat(1,1,Qt_ux.size(2)).to(torch.bool)] = 0.
                ...
                prev_kt = kt
                Qt_ux_ = Qt_ux.clone()
                Qt_ux_[(1-If).unsqueeze(2).repeat(1,1,Qt_ux.size(2)).to(torch.bool)] = 0
                if self.n_ctrl == 1:
