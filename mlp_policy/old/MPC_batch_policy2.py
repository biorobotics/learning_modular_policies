...
This version adds last state input to control for policy warm start
...
from utils import wrap_to_pi, rotate, create_control_inputs2, divide_action
import pgnn
            ...
            for replan in range(n_replans):
                ...
                if use_policy:
                    ...
                    for t in range(T):
                        ...
                        node_inputs_control = create_control_inputs2(
                                last_state, state_approx, goals_world)
                ...
                try:
                 ...
                 # can get errors in the trajopt. In that case, abort it and try again.
                    print("Error in planning: " + str(sys.exc_info()[0]) + ' worker ' + str(worker_num))
                    traceback.print_exc()
                    print(' gave up on ' + urdf + ' plan ' + str(i_traj) + '/' + str(int(n_runs)))
                    break
