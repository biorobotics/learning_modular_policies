...
def train_control(control_save_path,
    ...
    print('Control training using only last action and not current action')
    modules = dict()
    ...
    print('Control n_designs_per_step: ' + str(n_designs_per_step))
    ...
    for param_group in optimizer.param_groups:
        print( 'Control LR: ' + str(param_group['lr']) )
